...
public class Lab03_1 {
    ...
    static String[][] playlist = new String[100][4];
    ...
    private static void nextMusic() {
        // jika pointer sudah mencapai akhir array, pointer kembali ke 0
    ...
    private static void deleteMusic() {
        ...
        if (jumlahMusik == 1){
            ...
            playlist[pointer][0] = null;
            playlist[pointer][1] = null;
            playlist[pointer][2] = null;
            playlist[pointer][3] = null;
            jumlahMusik--;
